...
pyproject  = tomllib.loads(pl.Path.cwd() / "../../pyproject.toml")
...
modindex_common_prefix                = ["sphinx_timeline_domain."]
...
extlinks = {
    # Add ':issue:' role:
    "issue": ("https://github.com/jgrey4296/sphinx_timeline_domain/issues/%s", "issue %s"),
}
